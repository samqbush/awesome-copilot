...
In v1.0.72+, you can also install skills through the plugins interface, which is especially useful for skills that are not bundled inside a plugin:
...
# Remove a skill installed this way
