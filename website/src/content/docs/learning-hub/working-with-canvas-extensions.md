...
Canvas support is also available in **GitHub Copilot CLI** starting with v1.0.71. When a CLI session is running an extension with a canvas, the canvas renders in a side panel (in supported terminal environments).
