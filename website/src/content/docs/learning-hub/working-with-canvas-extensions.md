...
In the GitHub Copilot app, create canvases from an active session using the `/create-canvas` skill. Canvas support is also available in the **Copilot CLI** *(v1.0.71+)* for extension-driven interactions directly from the terminal.
