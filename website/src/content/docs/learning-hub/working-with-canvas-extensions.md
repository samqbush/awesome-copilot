...
> **CLI canvas support (v1.0.71+)**: Canvas extensions are now also supported in the Copilot CLI. Extension-driven canvas interactions work in interactive CLI sessions, giving you canvas-based workflows outside the desktop app.
