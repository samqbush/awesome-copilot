...
If you're already working in Copilot CLI, you can open the GitHub Copilot app directly from your current directory (v1.0.81-7+):

```bash
copilot app
```

This opens the GitHub Copilot app with the context of the current directory — useful when you want to switch from a terminal session to the app's visual interface without navigating through the app manually. If the app isn't installed, the command surfaces an installation link.
