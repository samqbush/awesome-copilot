...
|----------|-------------------|
| Highest capability, complex reasoning | Claude Opus 5 *(v1.0.75+)* |
...
| Code-specialized tasks, large context | kimi-k2.7-code *(v1.0.68+)* or kimi-k3 *(pre-release)* |
| Fast iteration, cost-effective | gemini-3.6-flash *(v1.0.74+)* or grok-4.5 *(v1.0.76+)* |
