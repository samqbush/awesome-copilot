...
Yes, since v1.0.72. **Multi-turn subagents are always enabled**, meaning you can send follow-up messages to any running subagent directly from the parent session. This makes interactive course-correction possible mid-delegation — you don't have to wait for the subagent to finish before providing new guidance.
