...
As of v1.0.71, the **default maximum subagent nesting depth has been lowered from 6 to 4** to prevent runaway recursive delegation. If your workflow requires deeper nesting, usage-based billing users can increase `subagents.maxDepth` in their settings (up to 128).
